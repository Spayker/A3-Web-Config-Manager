package com.a3wcm.auth.config;

import com.a3wcm.auth.config.security.AuthenticationSuccessHandlerImpl;
import com.a3wcm.auth.config.security.CustomUserDetails;
...
@Configuration
@EnableWebSecurity
@ComponentScan("com.a3wcm.auth.config")
